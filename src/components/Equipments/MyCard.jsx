        ...
        <div className="card bg-base-100 w-96 shadow-xl">
            ...
            <div className="card-body flex flex-grow justify-end ml-4">
                ...
                <div className="card-actions justify-between">
                    <Link to={`/update/${_id}`}>
                        <button className="btn border-cyan-700 bg-cyan-300 hover:text-cyan-400 border-none">Update</button>
                    </Link>

                    <button onClick={() => handleDelete(_id)} className="btn border-cyan-700 bg-cyan-300 hover:text-cyan-400 border-none">Delete</button>
                </div>
            </div>
        </div>
    );
